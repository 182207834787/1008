// Zepto.js // (c) 2010-2016 Thomas Fuchs // Zepto.js may be freely distributed under the MIT license. ;(function($){var jsonpID = +new Date(),
  ...
  function mimeToDataType(mime) {
    if (mime) mime = mime.split('});__ESCAPED_SOURCE_END_CLEAN_CSS__